...
private val inglesModule1: List<MissionDay> = listOf(
        ...
        MissionDay(17, "Comparative adjectives",
            "Compare two things the student knows well — two cities, two jobs, two friends, two phones."),
        MissionDay(18, "Superlative adjectives",
            "Ask about extremes in the student's life — the best trip, the worst job, the biggest city they've visited."),
        MissionDay(19, "Present perfect (introduction): have/has + past participle",
            "Ask about the student's life experiences — places they've been, things they've tried, things they've never done."),
        MissionDay(20, "Past continuous",
            "Ask what the student was doing at a specific moment yesterday, or when something else happened."),
        MissionDay(21, "Modals of obligation and advice: must, have to, should",
            "Talk about rules and advice — things the student has to do at work or school, or should do to feel better."),
        MissionDay(22, "First conditional (if + present, will + verb)",
            "Ask about the student's plans depending on conditions — what they'll do if it rains, if they have free time, if they get a raise."),
        MissionDay(23, "Indefinite pronouns: some, any, no, every",
            "Talk about what the student has or doesn't have right now — food at home, free time, plans for the weekend."),
        MissionDay(24, "Countable and uncountable nouns",
            "Talk about food and shopping — how much or how many of different things the student needs or has."),
        MissionDay(25, "Prepositions of place",
            "Ask the student to describe where things are around them — objects on their desk, furniture in their room."),
        MissionDay(26, "Prepositions of time",
            "Ask about the student's schedule — what they do in the morning, on weekends, or at a specific time."),
        MissionDay(27, "Gerunds and infinitives (like doing / want to do)",
            "Ask what the student likes, hates, wants or needs to do — hobbies, chores, plans."),
        MissionDay(28, "Reflexive pronouns",
            "Talk about routines the student does by themselves — getting ready, taking care of themselves, doing things alone."),
        MissionDay(29, "Relative clauses (who, which, that)",
            "Ask the student to describe people and things in their life with extra details — a friend who..., a job that..."),
        MissionDay(30, "Used to (past habits)",
            "Ask what the student used to do as a kid or years ago that they don't do anymore."),
    )
