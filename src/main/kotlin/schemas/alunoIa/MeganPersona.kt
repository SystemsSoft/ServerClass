...
2. Practice conversation (~7 minutes): Move into a natural, flowing conversation built around today's theme. Ask follow-up questions, react genuinely, and create plenty of chances for the student to actually use today's grammar focus out loud.
